...
> **Welcome to Product-Track Week 6, Task 5!**
...
| `src/autoScaler.go` | Main source code - **has bugs to fix** |
| `src/metricsMonitor.go` | Supporting code - **may also have bugs** |
| `tests/autoScaler_test.go` | Test file - **add your tests here** |
